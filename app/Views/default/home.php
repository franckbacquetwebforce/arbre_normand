    	...
    	<div class="carousel-inner" role="listbox">
      	...
      	<div class="item">
  			...
  			<div class="item">
				...
				<div class="item">
  				<img class ="slider_img" src="<?= $this->assetUrl('images/images_1x2/2x1 (6).jpg') ?>" alt="Chania">
      	</div>
      	<div class="item">
    ...
    <!-- <div class="col-xs-12 col-md-9"> IDEM les col-xs... parents font déjà le boulot-->
      ...
      <!-- <article class="col-xs-12"> IDEM les col-xs... parents font déjà le boulot-->
        <h2 class="media-heading">Palissades</h2>
				<img class="img-responsive media-object" src="<?= $this->assetUrl('images/images_10x15/3x2 (30).jpg') ?>" alt="...">
        <p>
